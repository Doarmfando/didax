export const valueProps = [
  {
    ...
    text: "Formación directa, práctica y enfocada en las herramientas que el mercado exige hoy.",
  },
  {
    title: "El impacto que sientes",
    text: "Programas diseñados para mejorar tu productividad, tu criterio técnico y tu valor profesional.",
  },
  {
    title: "El socio, no el proveedor",
    text: "Acompañamos a profesionales y empresas con una mirada consultiva, no solo académica.",
  },
];

export const benefits = [
  "Capacitación práctica con profesionales en activo",
  "Transformación del capital humano empresarial",
...
export const companyServices = [
  {
    ...
    impact:
      "Prevención total. Evita multas, paralizaciones y protege la vida del equipo.",
  },
  {
    ...
    impact:
      "Liberación de hasta 30% de flujo de caja atrapado en inventario innecesario.",
  },
  {
    ...
    solution:
      "Estructuración de procesos de gestión humana y digitalización de indicadores.",
    impact: "Reducción de costos de contratación y mejora de productividad.",
  },
  {
    ...
    impact:
      "Detección y eliminación de fugas de hasta 15% en costos operativos.",
  },
  {
    ...
    impact: "Incremento de hasta 20% en la conversión de ventas.",
  },
  {
  ...
  },
  {
    ...
    impact: "Recuperación de hasta 10% de margen neto.",
  },
];
